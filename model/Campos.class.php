<?php
/**
 * Clase modelo para todas las plantillas de campos usados en los formularios. Cada método de campo regresa un stringo con los tags necesarios para desplegar el campo requerido
 * @author Ismael
 *
 */
